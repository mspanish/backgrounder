...
, parse: function(array) {
    ...
    if(typeof array == 'string'){
      array = array
        ...
        //.replace(SVG.regex.decimalNumbers,pathReduceDecimals) // round to precision 1
...
/* stacey tipton reiman precision hack */
function pathReduceDecimals(a, b, c, d) {
  /*if (isNaN(d)) 
    {return c + d
    }
  d = d.toFixed(1);
